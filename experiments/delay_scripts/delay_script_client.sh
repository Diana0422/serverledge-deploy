...
tc qdisc add dev $DEV parent 1:15 handle 11 netem delay 5ms 1ms # this is with normal distribution by default
#tc qdisc add dev $DEV parent 1:15 handle 11 netem delay 5ms 1ms distribution normal #FIXME distribution normal scatena kernel panic
